...
| Total Rust tests passing                               | **211** (incl. v1.0.13 ignore/gc/parents regression coverage) | — |
| Python SDK + Claude + CRIU adapter tests               | **27 passed, 2 skipped** (CRIU Linux-only paths) | — |
