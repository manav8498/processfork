...
- Rust **edition 2024**, MSRV **1.91** (1.85 → 1.88 was the `home` crate
  bump in v1.0.0; 1.88 → 1.91 was aws-sdk-s3 in v1.0.2 — both recorded
  in `claude-progress.json/assumptions[]`).
